...
Run:
    uvicorn funasr_server:app --host 0.0.0.0 --port 10095
or:
    python funasr_server.py --port 10095 --device cuda:1
...
_INDEX_HTML = "/home/ec2-user/audio-stack/demo/funasr_static/index.html"
...
if __name__ == "__main__":
    ...
    args = p.parse_args()
    _device = args.device  # noqa: F841 - reassigned for startup hook
